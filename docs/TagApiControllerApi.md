...
> ::models::TagsGroupedResponse get_tags_grouped_by_id_using_get1(ctx, app_ids, tag, optional)
...
[**::models::TagsGroupedResponse**](TagsGroupedResponse.md)
...
> ::std::collections::HashMap<String, ::models::Dimension> get_using_get(ctx, app_ids, tag, optional)
