...
pub struct BasicOrganizationDto {
  ...
  auth_methods: Option<Vec<::models::BasicAuthMethodDto>>,
  #[serde(rename = "name")]
  name: Option<String>,
  #[serde(rename = "status")]
...
impl BasicOrganizationDto {
  ...
  pub fn set_auth_methods(&mut self, auth_methods: Vec<::models::BasicAuthMethodDto>) {
    self.auth_methods = Some(auth_methods);
  }

  pub fn with_auth_methods(mut self, auth_methods: Vec<::models::BasicAuthMethodDto>) -> BasicOrganizationDto {
    self.auth_methods = Some(auth_methods);
    self
  }

  pub fn auth_methods(&self) -> Option<&Vec<::models::BasicAuthMethodDto>> {
