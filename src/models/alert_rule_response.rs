...
pub struct AlertRuleResponse {
  #[serde(rename = "data")]
  #[serde(default)]
  data: Option<AlertRuleResponseEntry>, 
  #[serde(rename = "errors")]
  #[serde(default)]
...
impl AlertRuleResponse {
  ...
  pub fn set_data(&mut self, data: AlertRuleResponseEntry) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: AlertRuleResponseEntry) -> AlertRuleResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&AlertRuleResponseEntry> {
    self.data.as_ref()
  }
  ...
  pub fn with_errors(mut self, errors: Vec<Error>) -> AlertRuleResponse {
    self.errors = Some(errors);
    self
  }
