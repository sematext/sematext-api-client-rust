...
pub struct TokenResponse {
  #[serde(rename = "data")]
  #[serde(default)]
  data: Option<TokenResponseEntry>, 
  #[serde(rename = "errors")]
  #[serde(default)]
...
impl TokenResponse {
  ...
  pub fn set_data(&mut self, data: TokenResponseEntry) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: TokenResponseEntry) -> TokenResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&TokenResponseEntry> {
    self.data.as_ref()
  }
  ...
  pub fn with_errors(mut self, errors: Vec<Error>) -> TokenResponse {
    self.errors = Some(errors);
    self
  }
