...
pub struct SubscriptionResponse {
  #[serde(rename = "data")]
  #[serde(default)]
  data: Option<SubscriptionResponseEntry>, 
  #[serde(rename = "errors")]
  #[serde(default)]
...
impl SubscriptionResponse {
  ...
  pub fn with_data(mut self, data: SubscriptionResponseEntry) -> SubscriptionResponse {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_errors(mut self, errors: Vec<Error>) -> SubscriptionResponse {
    self.errors = Some(errors);
    self
  }
