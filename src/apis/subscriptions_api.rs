...
pub trait SubscriptionsApi {
    ...
    fn delete_using_delete3(&self, updateable_subscription_id: i64) -> Box<Future<Item = ::models::GenericMapBasedApiResponse, Error = Error<serde_json::Value>>>;
    ...
    fn toggle_enabled_using_put(&self, updateable_subscription_id: i64, dto: ::models::UpdateSubscriptionDto) -> Box<Future<Item = ::models::SubscriptionResponse, Error = Error<serde_json::Value>>>;
    ...
    fn update_for_dash_using_put1(&self, dash_id: i64, subscription: ::models::SubscriptionDashboardDto) -> Box<Future<Item = ::models::SubscriptionResponse, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>SubscriptionsApi for SubscriptionsApiClient<C> {
    fn create_for_app_using_post(&self, app_id: i64, subscription: ::models::SubscriptionDto) -> Box<Future<Item = ::models::SubscriptionResponse, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::SubscriptionResponse, _> = serde_json::from_slice(&body);
    ...
    fn list_using_get3(&self, app_id: i64) -> Box<Future<Item = ::models::SubscriptionsResponse, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::SubscriptionsResponse, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
    ...
    fn send_app_report_using_post1(&self, app_id: i64, email_dto: ::models::ReportInfo) -> Box<Future<Item = ::models::MailReportResponse, Error = Error<serde_json::Value>>> {
        ...
        let serialized = serde_json::to_string(&email_dto).unwrap();
        req.headers_mut().set(hyper::header::ContentType::json());
        req.headers_mut().set(hyper::header::ContentLength(serialized.len() as u64));
        req.set_body(serialized);
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::MailReportResponse, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
