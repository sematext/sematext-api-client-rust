...
pub trait SubscriptionsApi {
    fn list_using_get1(&self, app_id: i64) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn send_report_using_post(&self, app_id: i64, email_dto: ::models::ReportInfo) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
}
