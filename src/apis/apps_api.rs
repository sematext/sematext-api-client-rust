...
pub trait AppsApi {
    fn get_app_types_using_get(&self, ) -> Box<Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn get_using_get(&self, any_state_app_id: i64) -> Box<Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn invite_app_guests_using_post(&self, invitation: ::models::Invitation) -> Box<Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn list_apps_users_using_get(&self, ) -> Box<Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn list_using_get(&self, ) -> Box<Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn update_description_using_put(&self, any_state_app_id: i64, update_details: ::models::AppDescription) -> Box<Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn update_using_put1(&self, dto: ::models::UpdateAppInfo, any_state_app_id: i64) -> Box<Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
}
