...
pub trait AppsApi {
    ...
    fn list_apps_users_using_get(&self, ) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn list_using_get(&self, ) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn update_description_using_put(&self, any_state_app_id: i64, update_details: ::models::AppDescription) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
