...
pub trait BillingApi {
    fn get_detailed_invoice_using_get(&self, service: &str, year: i32, month: i32) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn list_available_plans_using_get(&self, integration_id: i64, app_type: &str) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn update_plan_using_put(&self, app_id: i64, dto: ::models::BillingInfo) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
}
