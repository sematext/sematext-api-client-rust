...
pub struct AlertNotificationsApiClient<C: hyper::client::connect::Connect + Clone + Send + Sync> {
    configuration: Arc<configuration::Configuration<C>>,
}

impl<C: hyper::client::connect::Connect + Clone + Send + Sync + 'static> AlertNotificationsApiClient<C> {
    pub fn new(configuration: Arc<configuration::Configuration<C>>) -> AlertNotificationsApiClient<C> {
...
pub trait AlertNotificationsApi {
    async fn get_alert_notifications_for_app_using_post1(&self, body: crate::models::AlertNotificationRequest, app_id: i64) -> Result<NotificationsResponse, Error<serde_json::Value>>;
    async fn get_alert_notifications_for_user_using_post1(&self, body: crate::models::AlertNotificationRequest) -> Result<NotificationsResponse, Error<serde_json::Value>>;
}

#[async_trait::async_trait]
impl<C: hyper::client::connect::Connect + Clone + Send + Sync + 'static>AlertNotificationsApi for AlertNotificationsApiClient<C> {
 ///
 ...
 /// # Arguments
 ///
 /// * `body` - Get alert notifications for an app
 /// Default value of interval is 1d
 ///
 /// * `app_id` - Get alert notifications for an app
 /// Default value of interval is 1d
 ///
    async fn get_alert_notifications_for_app_using_post1(&self, body: crate::models::AlertNotificationRequest, app_id: i64) -> Result<NotificationsResponse, Error<serde_json::Value>> {
...
*/
 ...
 /// # Arguments
 ///
 /// * `body` - Get alert notifications for a user
 /// Default value of interval is 1d
 ///
    async fn get_alert_notifications_for_user_using_post1(&self, body: crate::models::AlertNotificationRequest) -> Result<NotificationsResponse, Error<serde_json::Value>> {
        let configuration: &configuration::Configuration<C> = self.configuration.borrow();
