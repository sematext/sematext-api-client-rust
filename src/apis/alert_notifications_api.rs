...
pub trait AlertNotificationsApi {
    fn get_alert_notifications_for_app_using_post(&self, app_id: i64, time_interval: ::models::AlertNotificationRequest) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
    fn get_alert_notifications_for_user_using_post(&self, time_interval: ::models::AlertNotificationRequest) -> Box<dyn Future<Item = ::models::GenericApiResponse, Error = Error<serde_json::Value>>>;
}
