...
pub struct LogsAppApiClient<C: hyper::client::connect::Connect + Clone + Send + Sync> {
    configuration: Arc<configuration::Configuration<C>>,
}

impl<C: hyper::client::connect::Connect + Clone + Send + Sync + 'static> LogsAppApiClient<C> {
    pub fn new(configuration: Arc<configuration::Configuration<C>>) -> LogsAppApiClient<C> {
        LogsAppApiClient {
...
pub trait LogsAppApi {
    async fn create_logsene_application(&self, body: crate::models::CreateAppInfo) -> Result<AppsResponse, Error<serde_json::Value>>;
}

#[async_trait::async_trait]
impl<C: hyper::client::connect::Connect + Clone + Send + Sync + 'static>LogsAppApi for LogsAppApiClient<C> {
 ///
 /// Create Logs App
 ///
 /// 
