...
pub struct MonitoringAppApiClient<C: hyper::client::connect::Connect + Clone + Send + Sync> {
    configuration: Arc<configuration::Configuration<C>>,
}

impl<C: hyper::client::connect::Connect + Clone + Send + Sync + 'static> MonitoringAppApiClient<C> {
    pub fn new(configuration: Arc<configuration::Configuration<C>>) -> MonitoringAppApiClient<C> {
...
pub trait MonitoringAppApi {
    async fn create_spm_application1(&self, body: crate::models::CreateAppInfo) -> Result<AppsResponse, Error<serde_json::Value>>;
}

#[async_trait::async_trait]
impl<C: hyper::client::connect::Connect + Clone + Send + Sync + 'static>MonitoringAppApi for MonitoringAppApiClient<C> {
 ///
 ...
 ///
    async fn create_spm_application1(&self, body: crate::models::CreateAppInfo) -> Result<AppsResponse, Error<serde_json::Value>> {
        ...
        let uri_str = format!("{}spm-reports/api/v3/apps{}", configuration.base_path, query_string);
