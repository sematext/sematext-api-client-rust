...
pub trait TagApiControllerApi {
    fn get_tag_names_using_get(&self, app_ids: &str, from: i64, to: i64, metrics: bool, logs: bool, events: bool, rum: bool) -> Box<dyn Future<Item = Value, Error = Error<serde_json::Value>>>;
    fn get_using_get2(&self, app_ids: &str, tag: Vec<String>, from: i64, to: i64, metrics: bool, logs: bool, events: bool, rum: bool) -> Box<dyn Future<Item = Value, Error = Error<serde_json::Value>>>;
    fn get_using_get3(&self, app_ids: &str, tag: Vec<String>, from: i64, to: i64, metrics: bool, logs: bool, events: bool, rum: bool) -> Box<dyn Future<Item = Value, Error = Error<serde_json::Value>>>;
}
