...
pub trait TagApiControllerApi {
    ...
    fn get_tags_grouped_by_id_using_get1(&self, app_ids: &str, tag: Vec<String>, from: i64, to: i64, metrics: bool, logs: bool, events: bool, rum: bool) -> Box<Future<Item = ::models::TagsGroupedResponse, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>TagApiControllerApi for TagApiControllerApiClient<C> {
    ...
    fn get_tags_grouped_by_id_using_get1(&self, app_ids: &str, tag: Vec<String>, from: i64, to: i64, metrics: bool, logs: bool, events: bool, rum: bool) -> Box<Future<Item = ::models::TagsGroupedResponse, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::TagsGroupedResponse, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
